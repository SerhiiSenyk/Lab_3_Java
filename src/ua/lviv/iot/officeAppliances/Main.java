...
import ua.lviv.iot.officeAppliances.managers.*;
import java.util.*;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Board board = new Board("chalky", new Size(100.0, 80.0, 5.0), "aluminum", 250.0,
        ...
        Calculator calculator = new Calculator("engineering", 64, new Size(15.2, 5.0, 0.5),
        ...
        System.out.println("Вибірка за кольором");
        ...
        System.out.println("Сортування за спаданням за ціною");
        System.out.println(officeAppliances);
